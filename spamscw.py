...
def mr_x():
    time.sleep(1)
    os.system("clear")
    print (" Subrek YT Tutorial Termux Guys")
    time.sleep(1)
    os.system("xdg-open https://www.youtube.com/@TutorialTermux")
    time.sleep(5)
    os.system("clear")
...
def banner_anjay_subs_mr_dark():
    ...
    print ("   ╚═╝┴  ┴ ┴┴ ┴     ╚═╝└─┘└┴┘")
    print ("")
    print ("    > Author  : Demias Syihab Aldino ")
    print ("    > YouTube : Tutorial Termux ")
    print ("    > Github  : github.com/maskprivate1457 ")       
    print ("")
